...
def show_intervalles(self, indexNom1, indexNom2, indexesNoms,indexesVars,
                     pourcent=100, longueur=1, pas=1):

    res = optimise_intervalles(self, indexNom1, indexNom2, indexesVars, pourcent, longueur, pas)
    # print(res)
    if res:
        lignes = []
        for r in res:
