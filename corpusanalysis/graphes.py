...
def graphe_deviation(self, indexNom, indexesVars, indexesNoms, pourcent, Pourcent):
    ...
    redindexNom = list(set(indexesNoms+[indexNom])).index(indexNom)
...
def show_graph_deviation(self, indexNom, indexesNoms, indexesVars,
    ...
    updateProxMatrices(self,indexesVars, list(set(indexesNoms+[indexNom])))
    graphe_deviation(self, indexNom, indexesVars, indexesNoms, percent, Percent)
    plt.show()
...
def show_graphs_deviation(self, indexesNoms, indexesVars,
                          percent=0, Percent=100):


    for n in indexesNoms:
        show_graph_deviation(self, n, indexesNoms, indexesVars,
                             percent, Percent)
