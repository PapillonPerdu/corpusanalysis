...
def load_db(self, db):
    ...
    self.vars_types_avec_def = [t for t in self.vars_types_types if self.vars_types_defs_dic[t]]
    self.vars_types_sans_def = [t for t in self.vars_types_types if not self.vars_types_defs_dic[t]]
    ...
    self.noms_types_avec_def = [t for t in  self.noms_types_types if self.noms_types_defs_dic[t]]
    self.noms_types_sans_def = [t for t in  self.noms_types_types if not self.noms_types_defs_dic[t]]
    ...
    self.noms_sans_def = [n for n in self.noms if self.noms_defs_dic[n] == '']
